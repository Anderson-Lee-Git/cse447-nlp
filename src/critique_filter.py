...
def main():
    ...
    read_path = "/gscratch/scrubbed/lee0618/cse447-nlp/src/data/raw_gen_text_96.json"
    #file to store filtered text
    write_to_path = "/gscratch/scrubbed/lee0618/cse447-nlp/src/data/filtered_text_96.json"
