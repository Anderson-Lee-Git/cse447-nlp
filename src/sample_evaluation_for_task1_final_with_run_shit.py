...
model1 = AutoModelForCausalLM.from_pretrained('roberta-base').cuda()
...
def train_batching_closed(model, optimizer, tokenizer, lr=1e-4, batch_size=16, epochs=3, prompts_train, prompts_valid, concat_prompts_train, concat_prompts_valid):
  # global prompts_train, prompts_valid, concat_prompts_train, concat_prompts_valid
...
losses, train_accuracies, log_valid_accuracies, open_valid_accuracies = train_batching_closed(model1, optimizer2, tokenizer1, concat_prompts_train, concat_prompts_valid, concat_prompts_test, prompts_train, prompts_valid, prompts_test)
...
losses, train_accuracies, log_valid_accuracies, open_valid_accuracies = train_batching_closed(model3, optimizer, tokenizer3, sci_concat_prompts_train, sci_concat_prompts_valid, sci_prompts_train, sci_prompts_valid)
losses, train_accuracies, log_valid_accuracies, open_valid_accuracies = train_batching_closed(model3, optimizer, tokenizer3, concat_prompts_train, concat_prompts_valid, concat_prompts_test, prompts_train, prompts_valid, prompts_test)
